...
| story-065 | Extend project.json settings schema for role-keyed port maps | not-started | - |
| story-066 | Core deterministic port assignment helper | not-started | story-065 |
