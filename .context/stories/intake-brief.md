...
- **`/idea` (bare):** Prompts the user for idea text; empty input retries, explicit cancellation exits with no file created and no inference from recent conversation. The browse/list selector is out of scope for v1 (story-062).
