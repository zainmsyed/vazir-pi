...
.pi/lib/vazir-helpers.ts — Shared story file helpers and VCS utilities
...
test_exec.js — Node child_process smoke test
types/node-runtime-ambient.d.ts — Node.js runtime ambient type declarations for Pi extensions
types/pi-runtime-ambient.d.ts — Pi and pi-tui runtime ambient type declarations for extensions
