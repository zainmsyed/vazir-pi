...
.pi/extensions/vazir-live-reload.ts — Watches extension source files and triggers Pi reloads during development
...
.pi/lib/vazir-helpers.ts — Shared story metadata, date, repo detection, and path helpers
...
test_exec.js — Small Node child-process smoke test
types/node-runtime-ambient.d.ts — Minimal ambient Node module declarations for TypeScript checking
types/pi-runtime-ambient.d.ts — Ambient pi-coding-agent and pi-tui type declarations
